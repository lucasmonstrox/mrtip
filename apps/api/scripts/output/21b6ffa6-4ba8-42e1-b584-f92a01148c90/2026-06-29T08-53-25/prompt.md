...
- **Finalização: 153 SoT total (4.14/jogo · em casa 4/jogo) · conversão 31%** (gols ÷ SoT)
- Sofre 4.35 SoT/jogo (adversário converte 31%) · cria 9.32 key passes/jogo
...
- **Finalização: 177 SoT total (4.78/jogo · fora 5/jogo) · conversão 32%** (gols ÷ SoT)
- Sofre 4.3 SoT/jogo (adversário converte 33%) · cria 9.76 key passes/jogo
...
- Nottingham Forest: λ_SoT 4.9 × conv 31% → **1.52 gols**
- AFC Bournemouth: λ_SoT 5.23 × conv 32% → **1.67 gols**
- total via SoT = 3.19
...
|---|---|---|
| 1x2 casa/E/fora | 31/25/44% | 35/23/42% |
| Over 1.5 | 77% | 83% |
| Over 2.5 | 54% | 62% |
| Over 3.5 | 31% | 40% |
| BTTS | 57% | 63% |
