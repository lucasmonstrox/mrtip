...
- Clima: few clouds · 23.4°C (sens. 23°C) · vento 2.7 m/s · umidade 48% · nuvens 22% (contexto — NÃO assuma que chuva/vento reduzem gols; nesta liga o tempo ruim NÃO teve correlação com o total: jogos de chuva severa/vento forte deram 2.9 gols/j vs 2.84 da liga)
- Descanso: Nottingham Forest 7 dias (último: liga, 2026-05-17) · AFC Bournemouth 5 dias (último: liga, 2026-05-19)
...
- Total **47 marcados / 50 sofridos** em 37j · média **1.27 marca / 1.35 sofre** por jogo
- **Em casa (18j): marca 1.06 / sofre 1.22** (19 gols) · por tempo: 1ºT 0.49/0.65 · 2ºT 0.78/0.7
- **Finalização: 153 SoT (4.14/j · casa 4/j) · conv 29%** (aberta, −3 pên) · sofre 4.35 SoT/j (adv 28%) · 9.32 KP/j
- **Volume: 12.5 chutes/j (7.7 na área) · 1.8 big chances/j** · posse 46.8%

### Estilo (feito/sofrido por jogo)
- **Temporada** (feito/sofrido por jogo): ataques perigosos 49.9/51.9 · chutes pra fora 4.4/4.6 · bloqueados 4/4.3 · de fora da área 4.8/4.4
- **Últimos 5** (feito/sofrido por jogo): ataques perigosos 33.6/61.8 · chutes pra fora 3.2/5.2 · bloqueados 2.8/6.4 · de fora da área 2.8/6.8

### Qualidade individual (notas · season vs forma)
- **Nota média do time (todas comps): 6.83**
  - **Elliot Anderson** nota **7.27** (season) · forma 7.45↑ (últ.5) · 3× MOTM · 37j
  - **Morgan Gibbs-White** nota **7.01** (season) · forma 7.51↑ (últ.5) · 4× MOTM · 38j
  - ⚠️(fora) **Murillo** nota **6.94** (season) · forma 6.86= (últ.5) · 1× MOTM · 26j
  - **Neco Williams** nota **6.94** (season) · forma 6.7↓ (últ.5) · 3× MOTM · 37j
  - ⚠️(fora) **Callum Hudson-Odoi** nota **6.92** (season) · forma 6.93= (últ.5) · 2× MOTM · 32j
  - **Igor Jesus** nota **6.86** (season) · forma 7.2↑ (últ.5) · 1× MOTM · 37j

### Forma & contexto (últimos 5 — cada resultado justificado)
- **Forma (momento) — últimos 5: DEVVV** (10pts) · **15 feitos / 6 sofridos** · marca 3↑ / sofre 1.2= g/j · SoT 4.8 feito / 5.2 sofrido
- **Consistência: MARCOU em 23/37** (casa 9/18 · fora 14/19) · não-marcou 14 · clean sheet 9 · BTTS 17/37
...
- @ **Manchester United** (fora · **D 2-3**) — adv 3º Eur-gar · você 16º salvo/s-alvo · seu fora até ali 1.4 marca/1.4 sofre
...
(NET na ótica do time: + pressiona / - sofre; magnitude = intensidade · minutos por faixa de 15 · **‖INTERVALO‖** = fim do 1ºT · após 90' é acréscimo. A linha **⚽** traz o minuto de cada gol (**✓**=ele marcou / **✗**=sofreu) — CRUZE com a curva: gol durante SURTO de pressão = pressão PRODUTIVA (sabe converter quando bate); gol sofrido numa QUEDA longa = vulnerável sob pressão. A linha **🛡️** é a atividade DEFENSIVA (interceptações+desarmes) por faixa de 15' (alta = o time defendendo/sob pressão ali) — defende MUITO numa faixa E sofre gol nela = **não segura**; defende pouco e não sofre = controla. Cruze também mandante × visitante: a janela onde um pressiona e o outro afunda é onde sai gol.)
  ...
  - @ Manchester United (FORA · D 2-3) — min 1→98:
    📈 pressão (net/min): 1'-15' [0 +1 0 -2 -3 -5 -3 -1 +1 0 0 0 +2 -3 -7] · 16'-30' [-8 -6 -3 -2 -1 +2 -1 -1 0 0 0 +2 +5 +5 +2] · 31'-45' [-2 0 +1 +2 +2 +1 +2 0 -4 -3 -2 -1 -3 0 0] · ‖INTERVALO‖ · 46'-60' [0 -3 -1 -4 -3 -5 -4 0 +5 +2 -3 -3 -3 -4 0] · 61'-75' [0 +3 +3 -2 -3 -3 -8 -8 -9 -9 -6 -6 -6 -2 -3] · 76'-90' [-3 -5 -1 -1 -1 -1 0 +16 +11 +4 +2 +5 +10 +4 +4] · 91'+ [+5 +4 +4 +2 -2 -4 -3 -6]
    ⚽ gols: 5'✗ 53'✓ 55'✗ 76'✗ 78'✓
    🛡️ defesa (interceptações+desarmes): 1'-15' **5** · 16'-30' **3** · 31'-45' **5** ‖ 46'-60' **4** · 61'-75' **5** · 76'-90' **8**
...
- **Nicolò Savona** (Knee Injury) — 2 gols + 0 assists até a data; season: **4% dos gols** do time (4% com assists); **últimos 5 jogos do time**: participou de 0/15 gols = **0%** (≈ estável); with/without: com ele 1 g/j (14j) vs sem ele 1.43 g/j (23j) = +43%; finaliza **0.21 SoT/jogo** (time: 3.79 SoT/j com ele vs 4.35 sem — volume mais estável que gols)  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
...
- **Dilane Bakwa** (Unknown Injury) — 0 gols + 2 assists até a data; season: **0% dos gols** do time (4% com assists); **últimos 5 jogos do time**: participou de 1/15 gols = **7%** (≈ estável); with/without: com ele 1.14 g/j (14j) vs sem ele 1.35 g/j (23j) = +18%; finaliza **0.21 SoT/jogo** (time: 4.36 SoT/j com ele vs 4 sem — volume mais estável que gols)
  - Defesa/criação (volume PRÓPRIO/jogo — o que sai do time com a ausência dele): **0 interceptações/j** (~0% do time) · 0.4 desarmes/j · 1.9 duelos ganhos/j · 0.6 cruz. certos/j · 0.6 dribles certos/j · 0.8 key passes/j
...
### Gols & finalização (season)
- Total **57 marcados / 53 sofridos** em 37j · média **1.54 marca / 1.43 sofre** por jogo
- **Fora (18j): marca 1.56 / sofre 1.83** (28 gols) · por tempo: 1ºT 0.7/0.59 · 2ºT 0.84/0.84
- **Finalização: 177 SoT (4.78/j · fora 5/j) · conv 29%** (aberta, −5 pên) · sofre 4.3 SoT/j (adv 30%) · 9.76 KP/j
- **Volume: 13.7 chutes/j (8.2 na área) · 2.5 big chances/j** · posse 50%

### Estilo (feito/sofrido por jogo)
- **Temporada** (feito/sofrido por jogo): ataques perigosos 49.3/52.4 · chutes pra fora 5.1/4.1 · bloqueados 4.1/4 · de fora da área 5.4/3.7
- **Últimos 5** (feito/sofrido por jogo): ataques perigosos 45.2/54.2 · chutes pra fora 4.8/4.6 · bloqueados 4.6/3.2 · de fora da área 5/1.8

### Qualidade individual (notas · season vs forma)
- **Nota média do time (todas comps): 6.81**
  - **Marcos Senesi** nota **7.03** (season) · forma 7.28↑ (últ.5) · 2× MOTM · 38j
  - **Rayan** nota **7.01** (season) · forma 7.11= (últ.5) · 14j
  - **Alex Scott** nota **7** (season) · forma 7.17↑ (últ.5) · 38j
  - **Antoine Semenyo** nota **6.98** (season) · forma 6.88= (últ.5) · 2× MOTM · 21j
  - **Marcus Tavernier** nota **6.95** (season) · forma 7.14↑ (últ.5) · 4× MOTM · 34j
  - **James Hill** nota **6.92** (season) · forma 7.03= (últ.5) · 3× MOTM · 28j

### Forma & contexto (últimos 5 — cada resultado justificado)
- **Forma (momento) — últimos 5: EVVEV** (11pts) · **9 feitos / 4 sofridos** · marca 1.8↑ / sofre 0.8↓ g/j · SoT 4.4 feito / 2.8 sofrido
- **Consistência: MARCOU em 30/37** (casa 15/19 · fora 15/18) · não-marcou 7 · clean sheet 11 · BTTS 24/37
_Situação de cada time AO ENTRAR no jogo (justifica o resultado): **salvo**=fora do rebaixamento · **salvo/s-alvo**=salvo E sem nada a jogar (tende a afrouxar) · **briga-Z**=lutava p/ não cair (se mata) · **briga-top**/**Eur-gar**=brigava/garantiu Europa · **REBAIX.**=já rebaixado. Sem rótulo = ainda indefinido naquela rodada._
...
- vs **Manchester City** (casa · **E 1-1**) — adv 2º Eur-gar · você 6º briga-top · seu casa até ali 1.6 marca/1.1 sofre
...
(NET na ótica do time: + pressiona / - sofre; magnitude = intensidade · minutos por faixa de 15 · **‖INTERVALO‖** = fim do 1ºT · após 90' é acréscimo. A linha **⚽** traz o minuto de cada gol (**✓**=ele marcou / **✗**=sofreu) — CRUZE com a curva: gol durante SURTO de pressão = pressão PRODUTIVA (sabe converter quando bate); gol sofrido numa QUEDA longa = vulnerável sob pressão. A linha **🛡️** é a atividade DEFENSIVA (interceptações+desarmes) por faixa de 15' (alta = o time defendendo/sob pressão ali) — defende MUITO numa faixa E sofre gol nela = **não segura**; defende pouco e não sofre = controla. Cruze também mandante × visitante: a janela onde um pressiona e o outro afunda é onde sai gol.)
  ...
  - vs Manchester City (CASA · E 1-1) — min 1→96:
    📈 pressão (net/min): 1'-15' [-1 +3 +2 -8 -8 -6 -4 -3 0 -1 -1 -1 -1 -5 -2] · 16'-30' [+1 0 -3 -1 +1 +1 +2 +2 -1 -1 -1 -2 -5 -3 -9] · 31'-45' [-6 -5 -5 -4 -3 -2 -2 -1 +3 +3 +2 -1 -1 0 -2] · ‖INTERVALO‖ · 46'-60' [-5 -7 -6 -5 -6 -5 -3 +3 +2 +1 0 -1 +2 +2 +3] · 61'-75' [+2 +4 +7 +3 0 0 +1 +1 +2 +2 0 -1 -4 -6 -4] · 76'-90' [-3 -6 -7 -9 -6 -3 -2 -1 -2 -1 0 0 +4 +5 +7] · 91'+ [+5 +5 +3 +1 -2 -6]
    ⚽ gols: 39'✓ 90'✗
    🛡️ defesa (interceptações+desarmes): 1'-15' **2** · 16'-30' **4** · 31'-45' **2** ‖ 46'-60' **8** · 61'-75' **2** · 76'-90' **2**
...
- **Ryan Christie** (Red Card Suspension) — 2 gols + 0 assists até a data; season: **4% dos gols** do time (4% com assists); **últimos 5 jogos do time**: participou de 0/9 gols = **0%** (≈ estável); with/without: com ele 1.46 g/j (26j) vs sem ele 1.73 g/j (11j) = +18%; finaliza **0.31 SoT/jogo** (time: 4.65 SoT/j com ele vs 5.09 sem — volume mais estável que gols)  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
...
- **Álex Jiménez** (Unknown Injury) — 1 gols + 0 assists até a data; season: **2% dos gols** do time (2% com assists); **últimos 5 jogos do time**: participou de 0/9 gols = **0%** (≈ estável); with/without: com ele 1.58 g/j (31j) vs sem ele 1.33 g/j (6j) = −16%; finaliza **0.16 SoT/jogo** (time: 4.87 SoT/j com ele vs 4.33 sem — volume mais estável que gols)  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
...
**1x2 por tempo** (λ da Rota B repartido pela proporção de gols de cada tempo — ÂNCORA de `one_x_two_1t`/`one_x_two_2t`): 1ºT casa/E/fora **25/41/34%** · 2ºT **34/34/32%**.
