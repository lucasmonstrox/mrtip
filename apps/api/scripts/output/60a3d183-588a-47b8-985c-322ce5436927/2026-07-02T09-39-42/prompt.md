...
**Retrospecto (1 confrontos na janela ingerida, ótica do Sunderland): 1V 0E 0D · gols 2-1** · over 2.5 em 1/1 · BTTS em 1/1
...
- **Nota média do time (todas comps): 6.79**
  ...
  - ⚠️(fora) **D. Ballard** nota **6.86** (season) · forma 5.63↓ (últ.5 do time: 6.4→6.1→4.4→–→– 📉 caindo) · **faltou 2/5** · 1× MOTM · 31j
  ...
  - **R. Mandava** nota **6.74** (season) · forma 6.6= (últ.5 do time: 5.8→6.5→6.6→7.2→6.9 📈 subindo) · 24j
