...
- Sunderland: 18º, 51 pts · Chelsea: 5º, 121 pts
...
- **Motivação de cada lado** (quem PRECISA vencer tende a atacar → +xG ofensivo / -solidez defensiva; quem não tem nada em jogo tende a baixar a intensidade → -xG do jogo todo). Pondere a direção:
  - Sunderland: 18º, 51 pts, 1 jogo(s) restante(s) (máx possível 54 pts)
  ...
  - Chelsea: 5º, 121 pts, 1 jogo(s) restante(s) (máx possível 124 pts)
  - já SEGURO do rebaixamento.
...
- Total na temporada: **121 gols marcados**, 93 sofridos em 75 jogos
- Média geral: marca 1.61 / sofre 1.24 por jogo
- **Fora (37j): marca 1.62 / sofre 1.35** (total 60 gols fora)
- Por tempo (casa+fora): 1ºT marca 0.73 sofre 0.59 · 2ºT marca 0.88 sofre 0.65
- **Finalização: 385 SoT total (5.13/jogo · fora 4.7/jogo) · conversão 31%** (gols ÷ SoT)
- Sofre 4.16 SoT/jogo (adversário converte 30%) · cria 11.36 key passes/jogo
...
- Marca por faixa (/j): 0-15: 0.21 · 16-30: 0.24 · 31-45: 0.28 · 46-60: 0.33 · 61-75: 0.25 · 76-90: 0.29
- Sofre por faixa (/j): 0-15: 0.23 · 16-30: 0.16 · 31-45: 0.2 · 46-60: 0.19 · 61-75: 0.17 · 76-90: 0.29
- 1ºT: marca 55 / sofre 44 (totais na temporada)
### Desfalques de Chelsea neste jogo
- **Estêvão** (Unknown Injury) — 2 gols + 2 assists até a data; season: **2% dos gols** do time (3% com assists); **últimos 5 jogos do time**: participou de 0/4 gols = **0%** (≈ estável); with/without: com ele 1.45 g/j (22j) vs sem ele 1.68 g/j (53j) = +16%; finaliza **0.36 SoT/jogo** (time: 4.59 SoT/j com ele vs 5.36 sem — volume mais estável que gols)
- **Jamie Gittens** (Doubtful) — 0 gols + 2 assists até a data; season: **0% dos gols** do time (2% com assists); **últimos 5 jogos do time**: participou de 0/4 gols = **0%** (≈ estável); with/without: com ele 2.06 g/j (16j) vs sem ele 1.49 g/j (59j) = −28%; finaliza **0.13 SoT/jogo** (time: 5.56 SoT/j com ele vs 5.02 sem — volume mais estável que gols)
- **Roméo Lavia** (Doubtful) — 0 gols + 1 assists até a data; season: **0% dos gols** do time (1% com assists); **últimos 5 jogos do time**: participou de 0/4 gols = **0%** (≈ estável); with/without: com ele 1.39 g/j (28j) vs sem ele 1.74 g/j (47j) = +25%; finaliza **0 SoT/jogo** (time: 4.93 SoT/j com ele vs 5.26 sem — volume mais estável que gols)
- **Mykhaylo Mudryk** (Doping Ban) — 0 gols + 0 assists até a data; season: **0% dos gols** do time (0% com assists); **últimos 5 jogos do time**: participou de 0/4 gols = **0%** (≈ estável); with/without: com ele 2.29 g/j (7j) vs sem ele 1.54 g/j (68j) = −33%; finaliza **0.14 SoT/jogo** (time: 6.14 SoT/j com ele vs 5.03 sem — volume mais estável que gols)  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
- **C. Wiley** (Adductor Injury) — 0 gols + 0 assists até a data; season: **0% dos gols** do time (0% com assists); **últimos 5 jogos do time**: participou de 0/4 gols = **0%** (≈ estável); with/without: com ele 0 g/j (0j) vs sem ele 1.61 g/j (75j) = −0%  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
...
|---|---|---|---|
| 0-15 | 0.05 | 0.23 | 0.28 |
| 16-30 | 0.16 | 0.16 | 0.32 |
| 31-45 | 0.11 | 0.2 | 0.31 |
| 46-60 | 0.14 | 0.19 | 0.33 |
| 61-75 | 0.27 | 0.17 | 0.44 |
| 76-90 | 0.35 | 0.29 | 0.64 |

**Chelsea atacando × Sunderland defendendo**
| Faixa | Chelsea marca/j | Sunderland sofre/j | índice janela |
|---|---|---|---|
| 0-15 | 0.21 | 0.22 | 0.43 |
| 16-30 | 0.24 | 0.14 | 0.38 |
| 31-45 | 0.28 | 0.27 | 0.55 |
| 46-60 | 0.33 | 0.19 | 0.52 |
| 61-75 | 0.25 | 0.24 | 0.49 |
| 76-90 | 0.29 | 0.22 | 0.51 |
...
- λ Sunderland (casa) = 1.13 · λ Chelsea (fora) = 1.3 · total = 2.43

**Rota B — SoT × conversão** (volume de finalização via Poisson, depois × conversão do time — menos ruído):
- Sunderland: λ_SoT 3.32 × conv 32% → **1.06 gols**
- Chelsea: λ_SoT 4.45 × conv 31% → **1.38 gols**
- total via SoT = 2.44
- **Índice de volume do jogo**: λ_SoT total 7.8 vs média da liga 8.8 SoT → **ABAIXO** (jogo travado → pressão de UNDER)
...
|---|---|---|
| 1x2 casa/E/fora | 32/27/40% | 29/27/44% |
| Over 1.5 | 70% | 70% |
| Over 2.5 | 44% | 44% |
| Over 3.5 | 23% | 23% |
| BTTS | 49% | 49% |
