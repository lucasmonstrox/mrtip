...
- **Team totals** (marginais do λ da Rota B — a prob de CADA time marcar; base do `team_total`): AFC Bournemouth over 0.5 **75%** / over 1.5 **40%** · Crystal Palace over 0.5 **49%** / over 1.5 **15%**
