...
- **Motivação de cada lado** (quem PRECISA vencer tende a atacar → +xG ofensivo / -solidez defensiva; quem não tem nada em jogo tende a baixar a intensidade → -xG do jogo todo). Pondere a direção:
  ...
  - já SEGURO do rebaixamento.
  - pode ENTRAR no G-Champions — motivado a vencer.
...
- **Callum Hudson-Odoi** (Muscle Injury) — 3 gols + 4 assists até a data; representa **6% dos gols** do time (15% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 0.93 g/j (30j) vs sem ele 2.71 g/j (7j) = +191%; finaliza **0.33 SoT/jogo** (time: 3.9 SoT/j com ele vs 5.14 sem — volume mais estável que gols)
- **Nicolò Savona** (Knee Injury) — 2 gols + 0 assists até a data; representa **4% dos gols** do time (4% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 1 g/j (14j) vs sem ele 1.43 g/j (23j) = +43%; finaliza **0.21 SoT/jogo** (time: 3.79 SoT/j com ele vs 4.35 sem — volume mais estável que gols)
- **Dilane Bakwa** (Unknown Injury) — 0 gols + 2 assists até a data; representa **0% dos gols** do time (4% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 1.14 g/j (14j) vs sem ele 1.35 g/j (23j) = +18%; finaliza **0.21 SoT/jogo** (time: 4.36 SoT/j com ele vs 4 sem — volume mais estável que gols)
- **Murillo** (Unknown Injury) — 1 gols + 0 assists até a data; representa **2% dos gols** do time (2% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 1.32 g/j (25j) vs sem ele 1.17 g/j (12j) = −11%; finaliza **0.16 SoT/jogo** (time: 3.56 SoT/j com ele vs 5.33 sem — volume mais estável que gols)
- **Ola Aina** (Doubtful) — 0 gols + 1 assists até a data; representa **0% dos gols** do time (2% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 1.5 g/j (18j) vs sem ele 1.05 g/j (19j) = −30%; finaliza **0.06 SoT/jogo** (time: 3.94 SoT/j com ele vs 4.32 sem — volume mais estável que gols)
- **Willy Boly** (Knee Injury) — 0 gols + 0 assists até a data; representa **0% dos gols** do time (0% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 0 g/j (0j) vs sem ele 1.27 g/j (37j) = −0%  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
- **Eric da Silva Moreira** (Unknown Injury) — 0 gols + 0 assists até a data; representa **0% dos gols** do time (0% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 0 g/j (0j) vs sem ele 1.27 g/j (37j) = −0%  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
...
- **Ryan Christie** (Red Card Suspension) — 2 gols + 0 assists até a data; representa **4% dos gols** do time (4% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 1.46 g/j (26j) vs sem ele 1.73 g/j (11j) = +18%; finaliza **0.31 SoT/jogo** (time: 4.65 SoT/j com ele vs 5.09 sem — volume mais estável que gols)
- **Álex Jiménez** (Unknown Injury) — 1 gols + 0 assists até a data; representa **2% dos gols** do time (2% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 1.58 g/j (31j) vs sem ele 1.33 g/j (6j) = −16%; finaliza **0.16 SoT/jogo** (time: 4.87 SoT/j com ele vs 4.33 sem — volume mais estável que gols)
- **Julio Soler** (Muscle Injury) — 0 gols + 0 assists até a data; representa **0% dos gols** do time (0% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 1 g/j (3j) vs sem ele 1.59 g/j (34j) = +59%; finaliza **0 SoT/jogo** (time: 6 SoT/j com ele vs 4.68 sem — volume mais estável que gols)  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
- **M. Akinmboni** (Muscle Injury) — 0 gols + 0 assists até a data; representa **0% dos gols** do time (0% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 0 g/j (0j) vs sem ele 1.54 g/j (37j) = −0%  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
