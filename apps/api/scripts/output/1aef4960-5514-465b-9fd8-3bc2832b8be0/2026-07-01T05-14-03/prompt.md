...
- **Nota média do time (todas comps): 6.89**
  - **Enzo Fernández** nota **7.25** (season) · forma 7.22= (últ.5) · 9× MOTM · 42j
  - ⚠️(fora) **João Pedro** nota **7.1** (season) · forma 6.98= (últ.5) · 4× MOTM · 41j
  - **Moisés Caicedo** nota **7.08** (season) · forma 6.87↓ (últ.5) · 2× MOTM · 38j
  - **Reece James** nota **7.08** (season) · forma 7.21= (últ.5) · 1× MOTM · 30j
  - **Pedro Neto ** nota **7.04** (season) · forma 6.71↓ (últ.5) · 3× MOTM · 42j
  - **Alejandro Garnacho** nota **7.03** (season) · forma 6.72↓ (últ.5) · 3× MOTM · 31j
...
- **Nota média do time (todas comps): 6.76**
  ...
  - **Pedro Porro** nota **7.01** (season) · forma 7.61↑ (últ.5) · 4× MOTM · 35j
  - **Xavi Simons ** nota **6.97** (season) · forma 6.98= (últ.5) · 2× MOTM · 31j
  - **João Palhinha** nota **6.91** (season) · forma 6.84= (últ.5) · 3× MOTM · 34j
  - **Richarlison** nota **6.91** (season) · forma 6.66↓ (últ.5) · 4× MOTM · 33j
  - **Rodrigo Bentancur ** nota **6.88** (season) · forma 7.1↑ (últ.5) · 26j
