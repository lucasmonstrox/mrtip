...
- Agregados: `total`, `total_1t`, `total_2t`, `over25_prob`, `btts_prob`.
- **1x2 (home/draw/away)** em TRÊS recortes: `one_x_two` (resultado do jogo em 90min), `one_x_two_1t`
  (quem vence o **placar do 1º tempo**) e `one_x_two_2t` (quem vence o **2º tempo isolado**, contando só os gols do intervalo ao fim). Derive cada um do Poisson com os λ do respectivo tempo.
