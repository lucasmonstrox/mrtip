...
- **Hugo Ekitiké** (Unknown Injury) — 11 gols + 4 assists até a data; representa **18% dos gols** do time (24% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 1.68 g/j (28j) vs sem ele 1.67 g/j (9j) = −1%; finaliza **0.68 SoT/jogo** (time: 4.86 SoT/j com ele vs 3.67 sem — volume mais estável que gols)
- **Conor Bradley** (Knee Injury) — 0 gols + 1 assists até a data; representa **0% dos gols** do time (2% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 1.47 g/j (15j) vs sem ele 1.82 g/j (22j) = +24%; finaliza **0 SoT/jogo** (time: 3.6 SoT/j com ele vs 5.23 sem — volume mais estável que gols)
- **Giovanni Leoni** (Cruciate Ligament Tear) — 0 gols + 0 assists até a data; representa **0% dos gols** do time (0% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 0 g/j (0j) vs sem ele 1.68 g/j (37j) = −0%  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
- **S. Bajcetic Maquieira** (Unknown Injury) — 0 gols + 0 assists até a data; representa **0% dos gols** do time (0% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 0 g/j (0j) vs sem ele 1.68 g/j (37j) = −0%  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
...
- **Fábio Carvalho** (Unknown Injury) — 1 gols + 0 assists até a data; representa **2% dos gols** do time (2% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 0.83 g/j (6j) vs sem ele 1.58 g/j (31j) = +90%; finaliza **0.17 SoT/jogo** (time: 2.83 SoT/j com ele vs 4.13 sem — volume mais estável que gols)
- **Rico Henry** (Unknown Injury) — 0 gols + 1 assists até a data; representa **0% dos gols** do time (2% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 1.64 g/j (25j) vs sem ele 1.08 g/j (12j) = −34%; finaliza **0 SoT/jogo** (time: 4.12 SoT/j com ele vs 3.5 sem — volume mais estável que gols)
- **Antoni Milambo** (Cruciate Ligament Tear) — 0 gols + 0 assists até a data; representa **0% dos gols** do time (0% com assists) → o ataque perde isso se ele não jogar; with/without: com ele 1 g/j (1j) vs sem ele 1.47 g/j (36j) = +47%; finaliza **0 SoT/jogo** (time: 3 SoT/j com ele vs 3.94 sem — volume mais estável que gols)  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
