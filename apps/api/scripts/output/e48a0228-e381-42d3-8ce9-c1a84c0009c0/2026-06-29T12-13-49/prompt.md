...
- **Finalização: 169 SoT total (4.57/jogo · em casa 5.11/jogo) · conversão 36%** (jogada aberta ÷ SoT; exclui 1 pênaltis)
- Sofre 4.11 SoT/jogo (adversário converte 32%) · cria 12.08 key passes/jogo
- **Volume (chutes): 15.3/jogo (9.9 na área) · 2.7 big chances criadas/jogo** · posse 59.2% (contexto — posse sozinha NÃO prevê gol)
...
- **Finalização: 145 SoT total (3.92/jogo · fora 3.72/jogo) · conversão 32%** (jogada aberta ÷ SoT; exclui 8 pênaltis)
- Sofre 4.3 SoT/jogo (adversário converte 29%) · cria 8.08 key passes/jogo
- **Volume (chutes): 10.6/jogo (8 na área) · 3.1 big chances criadas/jogo** · posse 47.8% (contexto — posse sozinha NÃO prevê gol)
