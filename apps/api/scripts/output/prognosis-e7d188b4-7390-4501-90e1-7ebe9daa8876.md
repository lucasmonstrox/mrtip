# Prognóstico de expected goals — Sunderland x Manchester United
...
- Clima: moderate rain · 7.6°C (sens. 4°C) · vento 6.7 m/s · umidade 90% · nuvens 100% (contexto — NÃO assuma que chuva/vento reduzem gols; nesta liga o tempo ruim NÃO teve correlação com o total: jogos de chuva severa/vento forte deram 2.9 gols/j vs 2.84 da liga)
- Descanso: Sunderland 7 dias (último: liga, 2026-05-02) · Manchester United 6 dias (último: liga, 2026-05-03)
- Viagem do visitante: ~172 km
...
- Sunderland: 12º, 47 pts · Manchester United: 3º, 64 pts
...
- **Motivação de cada lado** (quem PRECISA vencer tende a atacar → +xG ofensivo / -solidez defensiva; quem não tem nada em jogo tende a baixar a intensidade → -xG do jogo todo). Pondere a direção:
  - Sunderland: 12º, 47 pts, 3 jogo(s) restante(s) (máx possível 56 pts)
  ...
  - Manchester United: 3º, 64 pts, 3 jogo(s) restante(s) (máx possível 73 pts)
  - já SEGURO do rebaixamento.
  - vaga de Champions praticamente garantida.
  - → motivação: **baixa** — NÃO precisa lutar — Champions praticamente garantida
  - disputa pela vaga (3º): o Manchester United **precisa vencer** pra travar (empate ainda deixa 2 rival vivo). Quem ainda ameaça → Liverpool (4º, 58 pts, máx 67) pode **passar em pontos** — vencendo, se o Manchester United tropeçar; Aston Villa (5º, 58 pts, máx 67) pode **passar em pontos** — vencendo, se o Manchester United tropeçar
...
## Sunderland (manda) — até 2026-05-09

### Gols & finalização (season)
- Total **37 marcados / 46 sofridos** em 35j · média **1.06 marca / 1.31 sofre** por jogo
- **Em casa (17j): marca 1.35 / sofre 1.12** (23 gols) · por tempo: 1ºT 0.34/0.63 · 2ºT 0.71/0.69
- **Finalização: 118 SoT (3.37/j · casa 3.47/j) · conv 28%** (aberta, −4 pên) · sofre 4.77 SoT/j (adv 26%) · 6.89 KP/j
- **Volume: 10.1 chutes/j (7.2 na área) · 1.7 big chances/j** · posse 44.5%

### Estilo (feito/sofrido por jogo)
- **Temporada** (feito/sofrido por jogo): ataques perigosos 44.9/56.8 · chutes pra fora 3.8/5.5 · bloqueados 2.9/4.5 · de fora da área 2.9/5.2
- **Últimos 5** (feito/sofrido por jogo): ataques perigosos 53.8/47.6 · chutes pra fora 4.2/5.2 · bloqueados 4.2/3 · de fora da área 4.4/5

### Qualidade individual (notas · season vs forma)
- **Nota média do time (todas comps): 6.78**
  - **Granit Xhaka** nota **7.13** (season) · forma 7.15= (últ.5) · 2× MOTM · 33j
  - **Enzo Le Fée** nota **7.02** (season) · forma 7.1= (últ.5) · 5× MOTM · 37j
  - **Nordi Mukiele** nota **6.99** (season) · forma 6.76↓ (últ.5) · 1× MOTM · 32j
  - **Robin Roefs** nota **6.97** (season) · forma 6.8↓ (últ.5) · 3× MOTM · 34j
  - **Omar Alderete** nota **6.87** (season) · forma 6.54↓ (últ.5) · 2× MOTM · 32j
  - ⚠️(fora) **D. Ballard** nota **6.86** (season) · forma 6.13↓ (últ.5) · 1× MOTM · 31j

### Forma & contexto (últimos 5 — cada resultado justificado)
- **Forma (momento) — últimos 5: EDDVV** (7pts) · **7 feitos / 11 sofridos** · marca 1.4↑ / sofre 2.2↑ g/j · SoT 4.4 feito / 6.2 sofrido
- **Consistência: MARCOU em 23/35** (casa 13/17 · fora 10/18) · não-marcou 12 · clean sheet 10 · BTTS 16/35
...
- @ **Newcastle United** (fora · **V 2-1**) — adv 11º · você 13º · seu fora até ali 0.5 marca/1.4 sofre
- vs **Tottenham Hotspur** (casa · **V 1-0**) — adv 18º briga-Z · você 12º · seu casa até ali 1.5 marca/0.9 sofre
- @ **Aston Villa** (fora · **D 3-4**) — adv 4º briga-top · você 11º · seu fora até ali 0.6 marca/1.4 sofre
- vs **Nottingham Forest** (casa · **D 0-5**) — adv 16º briga-Z · você 11º · seu casa até ali 1.4 marca/0.9 sofre
- @ **Wolverhampton Wanderers** (fora · **E 1-1**) — adv 20º REBAIX. · você 12º · seu fora até ali 0.8 marca/1.5 sofre
...
(NET na ótica do time: + pressiona / - sofre; magnitude = intensidade · minutos por faixa de 15 · **‖INTERVALO‖** = fim do 1ºT · após 90' é acréscimo. A linha **⚽** traz o minuto de cada gol (**✓**=ele marcou / **✗**=sofreu) — CRUZE com a curva: gol durante SURTO de pressão = pressão PRODUTIVA (sabe converter quando bate); gol sofrido numa QUEDA longa = vulnerável sob pressão. A linha **🛡️** é a atividade DEFENSIVA (interceptações+desarmes) por faixa de 15' (alta = o time defendendo/sob pressão ali) — defende MUITO numa faixa E sofre gol nela = **não segura**; defende pouco e não sofre = controla. Cruze também mandante × visitante: a janela onde um pressiona e o outro afunda é onde sai gol.)
  - @ Newcastle United (FORA · V 2-1) — min 1→99:
    📈 pressão (net/min): 1'-15' [0 0 -2 -1 -1 -1 -1 -2 -3 -5 -1 0 +1 +1 -1] · 16'-30' [-2 -1 -2 -1 0 -2 -1 0 +3 +7 +6 +6 +3 +2 -4] · 31'-45' [-2 -1 +1 0 0 0 0 0 -1 -1 +1 -2 -2 -2 -4] · ‖INTERVALO‖ · 46'-60' [-3 -3 -1 -1 -1 +4 +4 +4 +4 +3 +5 +12 +8 +6 +4] · 61'-75' [+3 +3 +5 +3 +3 +1 -2 -1 0 0 -1 -1 -2 -2 -2] · 76'-90' [-2 -2 -2 -2 -1 -1 0 +1 +1 +4 +1 +1 +1 +1 +4] · 91'+ [+9 +9 +6 +3 +2 0 -3 -3 -2]
    ⚽ gols: 10'✗ 57'✓ 90'✓
    🛡️ defesa (interceptações+desarmes): 1'-15' **3** · 16'-30' **2** · 31'-45' **1** ‖ 46'-60' **5** · 61'-75' **3** · 76'-90' **6**
  - vs Tottenham Hotspur (CASA · V 1-0) — min 1→101:
    📈 pressão (net/min): 1'-15' [0 -3 -2 +2 -1 +1 +1 +2 +3 +4 +2 +1 +1 +1 +1] · 16'-30' [+1 +1 +4 +7 +7 +6 +3 +3 +3 +2 -2 -4 -3 -2 -3] · 31'-45' [+1 +2 +3 +2 +1 +1 -2 -2 -2 -1 -1 0 0 0 -3] · ‖INTERVALO‖ · 46'-60' [-4 -4 -3 -4 -3 0 0 0 +5 +4 +3 +2 +4 0 0] · 61'-75' [+3 +2 +2 +1 +1 0 0 0 0 -3 -2 -1 -4 -3 -2] · 76'-90' [-5 -3 -4 -3 +1 +4 +4 +2 +2 0 0 0 +1 +1 +10] · 91'+ [+7 +4 +3 -3 -3 -3 -3 -8 -8 -5 -4]
    ⚽ gols: 61'✓
    🛡️ defesa (interceptações+desarmes): 1'-15' **5** · 16'-30' **2** · 31'-45' **5** ‖ 46'-60' **4** · 61'-75' **5** · 76'-90' **11**
...
- Marca por faixa (/j): 0-15: 0.06 · 16-30: 0.17 · 31-45: 0.11 · 46-60: 0.11 · 61-75: 0.29 · 76-90: 0.31
- Sofre por faixa (/j): 0-15: 0.23 · 16-30: 0.14 · 31-45: 0.26 · 46-60: 0.2 · 61-75: 0.26 · 76-90: 0.23
- 1ºT: marca 12 / sofre 22 (totais na temporada)

### Desfalques de Sunderland neste jogo
- **D. Ballard** (Red Card Suspension) — 2 gols + 0 assists até a data; season: **5% dos gols** do time (5% com assists); **últimos 5 jogos do time**: participou de 0/7 gols = **0%** (≈ estável); with/without: com ele 1.07 g/j (29j) vs sem ele 1 g/j (6j) = −7%; finaliza **0.31 SoT/jogo** (time: 3.41 SoT/j com ele vs 3.17 sem — volume mais estável que gols)  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
...
- **B. Traoré** (Knee Injury) — 1 gols + 0 assists até a data; season: **3% dos gols** do time (3% com assists); **últimos 5 jogos do time**: participou de 0/7 gols = **0%** (≈ estável); with/without: com ele 1.17 g/j (12j) vs sem ele 1 g/j (23j) = −15%; finaliza **0.5 SoT/jogo** (time: 2.67 SoT/j com ele vs 3.74 sem — volume mais estável que gols)
  - Defesa/criação (volume PRÓPRIO/jogo — o que sai do time com a ausência dele): **0.2 interceptações/j** (~3% do time) · 0.9 desarmes/j · 3.5 duelos ganhos/j · 0.1 cruz. certos/j · 1.2 dribles certos/j · 0.7 key passes/j
- **Simon Moore** (Broken Hand) — 0 gols + 0 assists até a data; season: **0% dos gols** do time (0% com assists); **últimos 5 jogos do time**: participou de 0/7 gols = **0%** (≈ estável); with/without: com ele 0 g/j (0j) vs sem ele 1.06 g/j (35j) = −0%  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
- **R. Mundle** (Hamstring Injury) — 0 gols + 0 assists até a data; season: **0% dos gols** do time (0% com assists); **últimos 5 jogos do time**: participou de 0/7 gols = **0%** (≈ estável); with/without: com ele 0.93 g/j (14j) vs sem ele 1.14 g/j (21j) = +23%; finaliza **0.14 SoT/jogo** (time: 3.5 SoT/j com ele vs 3.29 sem — volume mais estável que gols)  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
...
## Manchester United (visita) — até 2026-05-09

### Gols & finalização (season)
- Total **63 marcados / 48 sofridos** em 35j · média **1.8 marca / 1.37 sofre** por jogo
- **Fora (17j): marca 1.59 / sofre 1.53** (27 gols) · por tempo: 1ºT 0.74/0.46 · 2ºT 1.06/0.91
- **Finalização: 202 SoT (5.77/j · fora 4.65/j) · conv 29%** (aberta, −4 pên) · sofre 3.8 SoT/j (adv 33%) · 11.97 KP/j
- **Volume: 15.6 chutes/j (10.3 na área) · 2.8 big chances/j** · posse 52.1%

### Estilo (feito/sofrido por jogo)
- **Temporada** (feito/sofrido por jogo): ataques perigosos 49/49.7 · chutes pra fora 5.7/4.1 · bloqueados 4.1/3.7 · de fora da área 5.3/3.8
- **Últimos 5** (feito/sofrido por jogo): ataques perigosos 39.6/63.8 · chutes pra fora 3.8/5 · bloqueados 3.6/6.4 · de fora da área 4.4/6.6

### Qualidade individual (notas · season vs forma)
- **Nota média do time (todas comps): 6.91**
  - **Bruno Fernandes** nota **7.74** (season) · forma 7.7= (últ.5) · 10× MOTM · 34j
  - **Casemiro** nota **7.16** (season) · forma 7.34↑ (últ.5) · 4× MOTM · 34j
  - **Matheus Cunha** nota **7.13** (season) · forma 7.28= (últ.5) · 1× MOTM · 33j
  - **Bryan Mbeumo** nota **7.06** (season) · forma 6.73↓ (últ.5) · 2× MOTM · 31j
  - **Amad Diallo** nota **7.03** (season) · forma 6.6↓ (últ.5) · 30j
  - **Patrick Dorgu** nota **6.92** (season) · forma 7.26↑ (últ.5) · 1× MOTM · 24j

### Forma & contexto (últimos 5 — cada resultado justificado)
- **Forma (momento) — últimos 5: VVVDE** (10pts) · **9 feitos / 7 sofridos** · marca 1.8= / sofre 1.4= g/j · SoT 5.4 feito / 4.6 sofrido
- **Consistência: MARCOU em 32/35** (casa 16/18 · fora 16/17) · não-marcou 3 · clean sheet 6 · BTTS 26/35
_Situação de cada time AO ENTRAR no jogo (justifica o resultado): **salvo**=fora do rebaixamento · **salvo/s-alvo**=salvo E sem nada a jogar (tende a afrouxar) · **briga-Z**=lutava p/ não cair (se mata) · **briga-top**/**Eur-gar**=brigava/garantiu Europa · **REBAIX.**=já rebaixado. Sem rótulo = ainda indefinido naquela rodada._
- @ **AFC Bournemouth** (fora · **E 2-2**) — adv 10º · você 3º briga-top · seu fora até ali 1.6 marca/1.6 sofre
...
### Momentum minuto a minuto (últimos 5)
(NET na ótica do time: + pressiona / - sofre; magnitude = intensidade · minutos por faixa de 15 · **‖INTERVALO‖** = fim do 1ºT · após 90' é acréscimo. A linha **⚽** traz o minuto de cada gol (**✓**=ele marcou / **✗**=sofreu) — CRUZE com a curva: gol durante SURTO de pressão = pressão PRODUTIVA (sabe converter quando bate); gol sofrido numa QUEDA longa = vulnerável sob pressão. A linha **🛡️** é a atividade DEFENSIVA (interceptações+desarmes) por faixa de 15' (alta = o time defendendo/sob pressão ali) — defende MUITO numa faixa E sofre gol nela = **não segura**; defende pouco e não sofre = controla. Cruze também mandante × visitante: a janela onde um pressiona e o outro afunda é onde sai gol.)
  - @ AFC Bournemouth (FORA · E 2-2) — min 1→99:
    ...
    ⚽ gols: 61'✓ 67'✗ 71'✓ 81'✗
    🛡️ defesa (interceptações+desarmes): 1'-15' **4** · 16'-30' **3** · 31'-45' **6** ‖ 46'-60' **7** · 61'-75' **4** · 76'-90' **5**
...
### Distribuição de gols por faixa (season)
- Marca por faixa (/j): 0-15: 0.2 · 16-30: 0.2 · 31-45: 0.34 · 46-60: 0.31 · 61-75: 0.31 · 76-90: 0.43
- Sofre por faixa (/j): 0-15: 0.14 · 16-30: 0.14 · 31-45: 0.17 · 46-60: 0.29 · 61-75: 0.23 · 76-90: 0.4
- 1ºT: marca 26 / sofre 16 (totais na temporada)

### Desfalques de Manchester United neste jogo
- **Benjamin Sesko** (Doubtful) — 11 gols + 1 assists até a data; season: **17% dos gols** do time (19% com assists); **últimos 5 jogos do time**: participou de 2/9 gols = **22%** (≈ estável); with/without: com ele 1.8 g/j (30j) vs sem ele 1.8 g/j (5j) = −0%; finaliza **1.13 SoT/jogo** (time: 5.6 SoT/j com ele vs 6.8 sem — volume mais estável que gols)  ⚠️ with/without de GOLS NÃO confiável (sem contribuição direta ou amostra pequena) — olhe o de SoT
...
- **Matthijs de Ligt** (Back Injury) — 1 gols + 0 assists até a data; season: **2% dos gols** do time (2% com assists); **últimos 5 jogos do time**: participou de 0/9 gols = **0%** (≈ estável); with/without: com ele 1.62 g/j (13j) vs sem ele 1.91 g/j (22j) = +18%; finaliza **0.23 SoT/jogo** (time: 5.23 SoT/j com ele vs 6.09 sem — volume mais estável que gols)
...
**Sunderland atacando × Manchester United defendendo**
| Faixa | Sunderland marca/j | Manchester United sofre/j | índice janela |
|---|---|---|---|
| 0-15 | 0.06 | 0.14 | 0.2 |
| 16-30 | 0.17 | 0.14 | 0.31 |
| 31-45 | 0.11 | 0.17 | 0.28 |
| 46-60 | 0.11 | 0.29 | 0.4 |
| 61-75 | 0.29 | 0.23 | 0.52 |
| 76-90 | 0.31 | 0.4 | 0.71 |

**Manchester United atacando × Sunderland defendendo**
| Faixa | Manchester United marca/j | Sunderland sofre/j | índice janela |
|---|---|---|---|
| 0-15 | 0.2 | 0.23 | 0.43 |
| 16-30 | 0.2 | 0.14 | 0.34 |
| 31-45 | 0.34 | 0.26 | 0.6 |
| 46-60 | 0.31 | 0.2 | 0.51 |
| 61-75 | 0.31 | 0.26 | 0.57 |
| 76-90 | 0.43 | 0.23 | 0.66 |
...
- λ Sunderland (casa) = 1.36 · λ Manchester United (fora) = 1.44 · total = 2.8

**Rota B — SoT × conversão** (volume de finalização via Poisson, depois × conversão do time — menos ruído):
- Sunderland: λ_SoT 3.11 × conv 28% → **0.87 gols**
- Manchester United: λ_SoT 4.82 × conv 29% → **1.4 gols**
- total via SoT = 2.27
- **Índice de volume do jogo**: λ_SoT total 7.9 vs média da liga 8.4 SoT → na média
...
|---|---|---|
| 1x2 casa/E/fora | 36/25/39% | 23/27/49% |
| Over 1.5 | 77% | 66% |
| Over 2.5 | 53% | 40% |
| Over 3.5 | 31% | 19% |
| BTTS | 57% | 44% |

**1x2 por tempo** (λ da Rota B repartido pela proporção de gols de cada tempo — ÂNCORA de `one_x_two_1t`/`one_x_two_2t`): 1ºT casa/E/fora **15/50/36%** · 2ºT **24/38/38%**.
...
**Por time** — `home` (= Sunderland) e `away` (= Manchester United), cada um com:
