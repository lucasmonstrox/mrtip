...
49 feature(s). Fonte: arquivos em `docs/features/`. Convenções: [README.md](README.md).
...
- `match` → CORE-002, DOS-001, DOS-002, LIG-001, LIG-002, LIG-004, LIG-005, LIG-008, LIG-009, LIG-010, LIG-011, MOD-001, MOD-006, MOD-009, SIN-007, SIN-020 ⚠️ compartilhada
- `match_event` → SIN-017
