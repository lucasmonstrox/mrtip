...
testes:
  ...
  - "fix UI (2026-07-23): lista = outbound∪inbound (Grêmio passa a mostrar Inter); seed manual BRA 12 arestas (Botafogo×Fla/Flu/Vasco, espelhos Fla/Timão/Grêmio) em dev+prod; redeploy api 970265e2 · web be9acc56"
